...
-   Les différences de régulation s’expliquent aussi par des **facteurs institutionnels profonds** et des **trajectoires historiques singulières** :
    ...
    -   **En France**, héritière d’un **État centralisé et juridico-administratif**, la régulation s’inscrit dans une tradition de gouvernement par la haute fonction publique. La **noblesse d’État** (selon l’expression de Pierre Bourdieu ou la notion de "société de cour" d’Edward N. Eisenstadt) structure un pouvoir **technocratique** qui confère à la régulation une **dimension légitime, experte et étatique**. Cela favorise l’émergence d’agences publiques puissantes comme l’ANSM ou la HAS.
